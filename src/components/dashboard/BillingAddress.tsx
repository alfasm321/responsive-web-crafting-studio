...
const BillingAddress: React.FC = () => {
  return (
    <div className="bg-white p-4 rounded-md shadow-sm mb-6">
      <h3 className="text-sm font-medium text-gray-500 mb-4">BILLING ADDRESS</h3>
      <div className="space-y-3">
        <div className="flex items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500">First Floor, World No. 134, Road No. 19A, House No. 36/C, East No. PO., 10001, Chennai</p>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div className="flex-1">
            <p className="text-sm">Phone Number: +91 *********</p>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div className="flex-1">
            <p className="text-sm">Email: g****@gmail.com</p>
          </div>
        </div>
        
        <div className="mt-4">
          <button className="bg-rentev-orange hover:bg-orange-600 text-white px-4 py-2 rounded-md text-sm">
            EDIT ADDRESS
          </button>
        </div>
      </div>
